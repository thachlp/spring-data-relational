...
public interface Dialect {
	...
	/**
	 * @return {@literal true} if the database represented by this dialect supports all features necessary for Single
	 *         Select Query. These are mainly support for windowing functions and full outer joins.
	 */
	default boolean supportsSingleSelectQuery() {
		return false;
	}
}
