...
public class AggregateResultSetExtractorUnitTests {
	...
	class Conversions {
		...
		@Test
		void appliesConversionToProperty() throws SQLException {
		...
		@Test
		void appliesConversionToConstructorValue() throws SQLException {
		...
		@Test
		void appliesConversionToKeyValue() throws SQLException {
